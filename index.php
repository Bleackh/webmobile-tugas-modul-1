        ...
        <ol type="A">
            <li>Ayah
                <ul>
                    ...
                    <li>Jumlah Huruf : <?php hitung_jumlah_huruf($keluarga[0]); ?> </li>
            ...
            <li>Ibu
                <ul>
                    ...
                    <li>Jumlah Huruf : <?php hitung_jumlah_huruf($keluarga[1]); ?> </li>
            ...
            <li>Anak Pertama
                <ul>
                    ...
                    <li>Jumlah Huruf : <?php hitung_jumlah_huruf($keluarga[2]); ?> </li>
            ...
            <li>Anak Kedua
                <ul>
                    ...
                    <li>Jumlah Huruf : <?php hitung_jumlah_huruf($keluarga[3]); ?> </li>
